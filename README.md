...
- Poly Haven CC0: Asphalt 02, Leafy Grass, Rock Boulder Cracked PBR maps and Grasslands Sunset HDR at 2K; Sandy Gravel 02 and Dirt Aerial 02 use 2K PBR maps in Balanced and 4K albedo maps with 2K normal/roughness companions in High for the runoff shoulders. `download-assets-hq.mjs` records reproducible source downloads. See https://polyhaven.com/license .
