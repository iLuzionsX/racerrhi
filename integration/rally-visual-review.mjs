...
globalThis.__reviewPose=(view)=>{
 paused=true;mode='drive';countdown=0;$('intro').hidden=true;$('loading').hidden=true;$('hud').hidden=false;
 ...
 const poses={close:[[8,3,7],[0,1,0]],chase:[[0,3.7,-10],[0,1,11]],trackside:[[38,20,-32],[14,2,12]],rally:[[155,100,90],[180,15,160]]};
...
const types={'.js':'text/javascript','.mjs':'text/javascript','.html':'text/html','.json':'application/json','.wasm':'application/wasm','.jpg':'image/jpeg','.png':'image/png'};
