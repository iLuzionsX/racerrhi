...
const release=e=>{if(e.pointerId===pointer){pointer=null;input.held=false;}};const cancel=()=>{pointer=null;input.held=false;angle=0;input.steer=0;};wheel.onpointerup=release;wheel.onpointercancel=cancel;wheel.onlostpointercapture=release;
