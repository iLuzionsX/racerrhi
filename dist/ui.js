...
const release=()=>{pointer=null;input.held=false;};const cancel=()=>{release();angle=0;input.steer=0;};wheel.onpointerup=release;wheel.onpointercancel=cancel;wheel.onlostpointercapture=release;
