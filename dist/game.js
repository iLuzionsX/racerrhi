...
const visualReady=Promise.all([surfaces(scene,renderer,{asphalt:roadMat,grass:terrainMat,rock:rockMat,sand:sandMat,dirt:dirtMat},sky),foliage(scene,treePositions)]);
